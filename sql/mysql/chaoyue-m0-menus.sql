...
INSERT INTO system_menu (
  ...
  (3004, '国内渠道', 'marketing:tenant:catalog:query', 2, 1, 3003, 'domestic', 'ep:chat-dot-round', 'shell/ShellPage', 'TenantDomestic', 0, b'1', b'1', b'1', '1', NOW(), '1', NOW(), b'0'),
  (3005, '出海渠道', 'marketing:tenant:catalog:query', 2, 2, 3003, 'overseas', 'ep:ship', 'shell/ShellPage', 'TenantOverseas', 0, b'1', b'1', b'1', '1', NOW(), '1', NOW(), b'0'),
  ...
  (3008, '智能创作', 'marketing:tenant:create:query', 2, 5, 3000, 'create', 'ep:magic-stick', 'shell/ShellPage', 'TenantCreate', 0, b'1', b'1', b'1', '1', NOW(), '1', NOW(), b'0'),
